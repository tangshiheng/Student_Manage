...
<div class="container">
	...
	<table class="table table-hover">
		...
		<tr>
			...
			总学生数量${pageBean.totalSize }
			<c:if test="${pageBean.currentPage != 1 }">
			<a href="PageList?currentPage=1">首页</a>|
			<a href="PageList?currentPage=${pageBean.currentPage-1 }">上一页</a>
			</c:if>
			<c:if test="${pageBean.currentPage != pageBean.totalPage }">
			<a href="PageList?currentPage=${pageBean.currentPage+1 }">下一页</a>|
			<a href="PageList?currentPage=${pageBean.totalPage }">尾页</a>
			</c:if>
			</td>
		</tr>
	</table>
